...
import stella.modules.sql.global_bans_sql as sql
from stella import dispatcher, OWNER_ID, SUDO_USERS, DEV_USERS, SUPPORT_USERS, WHITELIST_USERS, STRICT_GBAN, GBAN_LOGS
from stella.modules.helper_funcs.chat_status import user_admin, is_user_admin, support_plus
from stella.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from stella.modules.helper_funcs.misc import send_to_list
from stella.modules.sql.users_sql import get_all_chats
...
def gban(bot: Bot, update: Update, args: List[str]):
    ...
    if int(user_id) == 680240877:
        message.reply_text("You have no permissions to ban sunny.")
        return
    ...
    if gban_time > 60:
        ...
        message.reply_text(f"Done! This gban took {gban_time} mins.")
    else:
        message.reply_text(f"Done! This gban took {gban_time} secs.")

    try:
        bot.send_message(user_id,
                         "You have been globally banned from all groups where I have administrative permissions."
                         " If you think that this was a mistake, you may appeal your ban here: @stellatm",
                         parse_mode=ParseMode.HTML)
    except:
...
/gbanstat
Note: You can appeal gbans or ask gbans at @SabrinaRoBot_Chat . 
"""
